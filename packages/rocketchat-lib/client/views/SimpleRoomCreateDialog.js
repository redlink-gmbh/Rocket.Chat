...
Template.SimpleRoomCreateDialog.helpers({
	autocomplete(key) {
	...
	config() {
		...
		return {
			filter: filter.get(),
			template_item: 'SimpleRoomCreateDialogAutocomplete',
...
Template.SimpleRoomCreateDialog.events({
	...acEvents,
...
Template.SimpleRoomCreateDialog.onRendered(function() {
	const instance = this;
...
Template.SimpleRoomCreateDialog.onCreated(function() {
	const instance = this;
